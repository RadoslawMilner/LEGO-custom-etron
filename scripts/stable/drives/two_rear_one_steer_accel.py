# The simple one and strong. Tested in various scenarios.
# 2x direct rear drive.
# 1 motor for front turning.
# Basic simple approach. Can be used for various vehicles.
